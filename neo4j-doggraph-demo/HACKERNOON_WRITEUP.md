...
The same pipeline behind a small Streamlit UI: question → generated Cypher (always shown) → grounded answer → raw rows. Aura-connected. Deployable on Streamlit Community Cloud's free tier in ~5 minutes.
